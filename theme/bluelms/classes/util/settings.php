...
class settings {
    ...
    public function __construct() {
        $this->theme = theme_config::load('bluelms');
    }
    ...
    public function frontpage_slideshow() {
        ...
        $defaultimage = new \moodle_url('/theme/bluelms/pix/default_slide.jpg');
    ...
    public function frontpage_marketingboxes() {
        if ($templatecontext['displaymarketingbox'] = $this->displaymarketingbox) {
            ...
            $defaultimage = new \moodle_url('/theme/bluelms/pix/default_markegingicon.svg');
