...
use html_writer;
use context_system;
use theme_bluelms\output\core_course\activity_navigation;
...
class core_renderer extends \theme_boost\output\core_renderer {
    ...
    public function standard_head_html() {
        ...
        $theme = theme_config::load('bluelms');
    ...
    public function body_attributes($additionalclasses = array()) {
        $hasaccessibilitybar = get_user_preferences('themebluelmssettings_enableaccessibilitytoolbar', '');
        ...
        $fonttype = get_user_preferences('themebluelmssettings_fonttype', '');
        if ($fonttype) {
    ...
    public function get_navbar_callbacks_data() {
        $callbacks = get_plugins_with_function('bluelms_additional_header', 'lib.php');
    ...
    public function get_module_footer_callbacks_data() {
        $callbacks = get_plugins_with_function('bluelms_module_footer', 'lib.php');
    ...
    /**
     * Show Admin Setting Button On THeader.
     *
     * @return string Final html code.
     */
    function settings_btn(){
        ...
        // $systemcontext = context_system::instance();
        $hassiteconfig = has_capability('moodle/site:configview', $systemcontext);
        if($hassiteconfig){
            $create_settings_url = new moodle_url('/admin/search.php');              
            
            $html .= html_writer::start_tag('a' , array('class' => 'btn_settings' , 'href' => $create_settings_url));
                $html .= html_writer::tag('i','', array ('class' => 'icon fa-regular fa-sun','aria-hidden'=>'true'));
               // $html .= html_writer::tag('span',get_string('setting_home', 'theme_bluelms'));
