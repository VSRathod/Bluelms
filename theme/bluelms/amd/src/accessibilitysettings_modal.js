    ...
    function(jQuery, Notification, CustomEvents, Modal, ModalRegistry, Ajax) {
        ...
        var AccessibilityModal = function(root) {
            ...
            var request = Ajax.call([{
                methodname: 'theme_bluelms_getthemesettings',
                args: {}
            }]);
        ...
        AccessibilityModal.TYPE = 'theme_bluelms-themesettings_modal';
        ...
        AccessibilityModal.prototype.registerEventListeners = function() {
            ...
            this.getModal().on(CustomEvents.events.activate, SELECTORS.SAVE_BUTTON, function() {
                var request = Ajax.call([{
                    methodname: 'theme_bluelms_savethemesettings',
                    args: {
        ...
        if (!registered) {
            ModalRegistry.register(AccessibilityModal.TYPE, AccessibilityModal, 'theme_bluelms/accessibilitysettings_modal');
            registered = true;
        }
