 ...
 * @return string
 */
function theme_bluelms_get_main_scss_content($theme) {
    global $CFG;
    ...
    } else if ($filename && ($presetfile = $fs->get_file($context->id, 'theme_bluelms', 'preset', 0, '/', $filename))) {
    ...
    // bluelms scss.
    $bluelmsvariables = file_get_contents($CFG->dirroot . '/theme/bluelms/scss/bluelms/_variables.scss');
    $bluelms = file_get_contents($CFG->dirroot . '/theme/bluelms/scss/default.scss');

    // Combine them together.
    $allscss = $bluelmsvariables . "\n" . $scss . "\n" . $bluelms;
 ...
 * @return string
 */
function theme_bluelms_get_extra_scss($theme) {
    $content = '';
 ...
 * @return string
 */
function theme_bluelms_get_pre_scss($theme) {
    $scss = '';
    $configurable = [
 ...
 */
function theme_bluelms_get_precompiled_css() {
    global $CFG;

    return file_get_contents($CFG->dirroot . '/theme/bluelms/style/moodle.css');
}
 ...
 * @return mixed
 */
function theme_bluelms_pluginfile($course, $cm, $context, $filearea, $args, $forcedownload, array $options = array()) {
