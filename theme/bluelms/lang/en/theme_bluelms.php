...
$string['pluginname'] = 'bluelms';
$string['configtitle'] = 'bluelms';
$string['choosereadme'] = 'bluelms is a modern highly-customisable theme. This theme is intended to be used directly, or as a parent theme when creating new themes utilising Bootstrap 4.';
...
$string['privacy:metadata:preference:themebluelmssettings_fonttype'] = 'The user\'s preference for font type.';
$string['privacy:metadata:preference:themebluelmssettings_enableaccessibilitytoolbar'] = 'The user\'s preference for enable the accessibility toolbar.';
...
$string['privacy:themebluelmssettings_fonttype'] = 'The current preference for the font type is: {$a}.';
$string['privacy:themebluelmssettings_enableaccessibilitytoolbar'] = 'The current preference for enable accessibility toolbar is to show it.';

$string['setting_home'] ="Administrator Setting";
