...
$THEME->scss = function($theme) {
    return theme_bluelms_get_main_scss_content($theme);
};
...
$THEME->extrascsscallback = 'theme_bluelms_get_extra_scss';
$THEME->prescsscallback = 'theme_bluelms_get_pre_scss';
$THEME->precompiledcsscallback = 'theme_bluelms_get_precompiled_css';
$THEME->yuicssmodules = [];
