...
/**
 * A drawer based layout for the bluelms theme.
 *
...
$templatecontext = [
    ...
    'headerbuttons' => \theme_bluelms\util\extras::get_mypublic_headerbuttons($context, $user),
    'editprofileurl' => \theme_bluelms\util\extras::get_mypublic_editprofile_url($user, $courseid),
...
$themesettings = new \theme_bluelms\util\settings();

$templatecontext = array_merge($templatecontext, $themesettings->footer());

echo $OUTPUT->render_from_template('theme_bluelms/mypublic', $templatecontext);
